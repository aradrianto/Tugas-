        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <center>
                        <img src="asset/lg.png" width="40%" alt="" srcset="">
                        <h3 class="panel-title">DECISION SUPPORT SYSTEM</h3>
                        <p><small>PROMETHEE</small></p>
                    </center>
                    </div>
                    <div class="panel-body">
                        <form action="config/proses_login.php" method="post">
                            <fieldset>
                                ...
                                <hr>
                                <p class="text-center">Distributed By <a href="https://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer">BlogBugaBagi</a></p>
                            </fieldset>
                        </form>
                    </div>
                </div>
